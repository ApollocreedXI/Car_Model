...
<html>
    ...
    <body>
        ...
        <form action="/predict" method="post">
            ...
            <label for="feature7">Feature 7:</label><br>
            <input type="number" step="any" id="feature7" name="feature7" required><br>
            <label for="feature8">Feature 8:</label><br>
            <input type="number" step="any" id="feature8" name="feature8" required><br>
            <label for="feature9">Feature 9:</label><br>
            <input type="number" step="any" id="feature9" name="feature9" required><br>
            <label for="feature10">Feature 10:</label><br>
            <input type="number" step="any" id="feature10" name="feature10" required><br><br>
